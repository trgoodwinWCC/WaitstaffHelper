...
public class WaitstaffAdapterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                Toast.makeText(WaitstaffAdapterScreen.this, "There are "+menuItemsArray.get(position).getSize()+" items in "+menuItemsArray.get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}